...
const tabs = [
  ...
  { name: 'inbox', path: '/inbox', iconKey: 'inbox' as const, label: 'Inbox' },
...
export function DesktopSidebar() {
  ...
  return (
    <>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '4px 12px 28px' }}>
          <span style={{ fontSize: 22, fontWeight: 800, letterSpacing: -0.5, color: TEXT }}>
            i<span style={{ color: ACCENT }}>w</span>ent
          </span>
        </div>
