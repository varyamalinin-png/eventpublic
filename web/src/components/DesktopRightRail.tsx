    ...
    <div style={cardStyle}>
      ...
      {recentChats.length === 0 ? (
        <p style={{ fontSize: 13.5, color: TEXT_DIM, margin: '6px 0 2px' }}>
          Пока нет переписок — начните диалог из карточки события или профиля.
        </p>
      ) : (
                ...
                <div style={{ minWidth: 0, flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 8 }}>
                    ...
                    <span style={{ fontSize: 11.5, color: TEXT_FAINT, flexShrink: 0 }}>
                      {timeAgo(chat.lastMessage?.createdAt ?? chat.lastActivity)}
                    </span>
                  </div>
  ...
  return (
    <>
      ...
      >
        ...
        {/* О платформе / полезное */}
        <div style={cardStyle}>
          <div style={{ fontSize: 11, textTransform: 'uppercase', letterSpacing: 1, color: TEXT_FAINT, marginBottom: 10, fontWeight: 600 }}>
            iWent
          </div>
          <p style={{ fontSize: 13.5, lineHeight: 1.55, color: TEXT_DIM, margin: 0 }}>
            Находите события рядом, создавайте свои и делитесь воспоминаниями вместе с теми, кто вам важен.
          </p>
          <Link href="/privacy" className="iwent-rail-link" style={{ ...linkRowStyle, marginTop: 14 }}>
