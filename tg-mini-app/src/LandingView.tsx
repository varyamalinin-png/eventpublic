          ...
          <div className="card">
            ...
            <div className="social-row">
              <button
                ...
                onClick={() => onOpenUrl(TELEGRAM_CHANNEL_URL)}
              >
            ...
            <button type="button" className="btn-ghost" onClick={onWriteBot}>
              Написать боту
            </button>
            {import.meta.env.DEV && TELEGRAM_BOT_CHAT_URL === TELEGRAM_CHANNEL_URL ? (
              <div className="hint">
                Для кнопки «Написать боту» задайте{' '}
                <code style={{ fontSize: 11 }}>VITE_TELEGRAM_BOT_USERNAME</code> в .env.
              </div>
            ) : null}
          </div>
        </div>
