...
export default function ParticipatedEventsScreen() {
  ...
  const handleEventPress = (event: Event) => {
    ...
    setTimeout(() => {
      ...
      if (eventIndex !== -1 && scrollViewRef.current) {
        ...
        const totalContentHeight = participatedEvents.length * totalItemHeight - marginBottom + 20;
  ...
  const getEventPressHandler = useStableItemHandler(participatedEvents, handleEventPress);
          ...
          {participatedEvents.map((event, index) => (
            <View 
              ...
              style={[
                ...
                index === participatedEvents.length - 1 && styles.lastEventCard
              ]}
            >
              <EventCard
                id={event.id}
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>{t.profile.participatedEventsTitle} {userData.name}</Text>
      </View>
