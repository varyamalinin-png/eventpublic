...
export default function AllEventsScreen() {
  ...
  const handleEventPress = (event: Event) => {
    ...
    setTimeout(() => {
      ...
      if (eventIndex !== -1 && scrollViewRef.current) {
        ...
        const totalContentHeight = allEvents.length * totalItemHeight - marginBottom + 20;
  ...
  const getEventPressHandler = useStableItemHandler(allEvents, handleEventPress);
          ...
          {allEvents.map((event, index) => (
            <View 
              ...
              style={[
                ...
                index === allEvents.length - 1 && styles.lastEventCard
              ]}
            >
              <EventCard
                id={event.id}
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>{t.profile.allEventsTitle} {userData.name}</Text>
      </View>
